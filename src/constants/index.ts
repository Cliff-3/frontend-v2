...
import miniyakLogo from "../assets/icons/miniyak.svg"
import tsdLogo from "../assets/icons/tsd.png"
import usdcLogo from "../assets/icons/usdc.svg"
import usdtLogo from "../assets/icons/usdt.svg"
import yakLogo from "../assets/icons/yak_black.png"
...
export const YAK_SWAP_CONTRACT_ADDRESSES: {
  [chainId in ChainId]: string
} = {
  [ChainId.AVALANCHE]: "0xd72Dc856868f964D37D01CeA7A7a3c1F4da4F98f",
  [ChainId.FUJI]: "",
  [ChainId.BSC]: "",
}
...
export const YAK_SWAP_TOKEN = new Token(
  {
    [ChainId.AVALANCHE]: "0x7f1e6A8730fEC77f27DAEECD82E1941518383a62",
    [ChainId.FUJI]: "",
    [ChainId.BSC]: "",
  },
  {
...
export const YAK_POOL_TOKENS = [mYAK, YAK]
...
export const POOLS_MAP: {
  ...
  [YAK_POOL_NAME]: {
    poolId: YAK_POOL_ID,
    lpToken: YAK_SWAP_TOKEN,
    poolTokens: YAK_POOL_TOKENS,
    isSwapPool: true,
  },
}
